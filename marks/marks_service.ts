...
// export async function handleStudentDetailsFromInternal(details: any): Promise<any> {
//     try {
//         const controlResult = await fetchMarksControlModal(details);

//         if (!controlResult.rows[0].marks_control) {
//             const fetchResult = await fetchStudentDetailsFromInternal(details);
...
//                 try {
//                     const insertResult = await insertStudentDetailsFromInternal(details);
//                     console.log("Inserted successfully!");
//                     return insertResult.rows;
//                 } catch (insertError) {
//                     console.log("Error in inserting student details: ", insertError);
//                     throw new Error("Internal server error in insertStudentDetails");
//                 }
//             } else {
//                 console.log("Updating student details...");
...
//                     try {
//                         const updateResult = await updateStudentDetailsFromInternal(details);
//                         console.log("Updated successfully!");
//                         return updateResult.rows;
//                     } catch (updateError) {
//                         console.log("Error in updating student details: ", updateError);
//                         throw new Error("Internal server error in updateStudentDetailsFromInternal");
//                     }
//                 } else {
//                     return "Internal marks are freezed!";
//                 }
//             }

//             const externalResults = await fetchTheStudentDetailsFromExternal(details);
//             if (externalResults && externalResults.length > 0 && externalResults[0].freeze_marks === true) {
//                 if (details.freeze_marks === true) {
//                     const rollnoMarksMap = new Map();
//                     for (let i = 0; i < details.rollno.length; i++) {
...
//                             try {
//                                 const insertResult = await insertIntoAggregateMarks(aggregateDetails);
//                                 console.log("Aggregate marks populated successfully!");
//                                 return insertResult.rows;
//                             } catch (insertError) {
//                                 console.log("Error in populating aggregate marks: ", insertError);
//                                 throw new Error("Internal server error in insertIntoAggregateMarks");
//                             }
//                         }
//                     }
//                 }
