...
function putDetailsByRollno(rollno, program, semester, phone, campus, emailid, gender, alternate_phone, father, mother, guardian, last_modified, password, program_type) {
    console.log("here");
    return new Promise((resolve, reject) => {
