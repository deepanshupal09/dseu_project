...
import { fetchExamControl, fetchUserByRollno, updateDetails, updateDetailsUser } from "@/app/actions/api";
import { Button, Dialog, DialogActions, DialogContent, DialogTitle, MenuItem, Select, SelectChangeEvent, Snackbar, TextField, Typography } from "@mui/material";
...
export default function Home() {
    ...
    useEffect(() => {
        ...
        if (user?.campus !== undefined) {
            fetchExamControl(token, user?.campus, user?.program, user?.semester.toString())
                .then((res) => {
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                            <div className="flex items-center mb-2">
                                                ...
                                                <p>
                                                    ...
                                                    <br />
                                                    {edit ? <TextField hiddenLabel className="mt-2" size="small" variant="filled" name="name" value={user?.name} disabled onChange={handleChange} /> : <span>{user?.name}</span>}
                                                </p>
                                            </div>
                                            <div className="flex items-center mb-2">
                                                <PersonIcon className="mr-2" />
                                                <p>
                                                    ...
                                                    <br />
                                                    {edit ? <TextField hiddenLabel className="mt-2" size="small" variant="filled" name="father" value={user?.father} onChange={handleChange} /> : <span>{user?.father}</span>}
                                                </p>
                                            </div>
                                            <div className="flex items-center mb-2">
                                                <PersonIcon className="mr-2" />
                                                ...
                                                <p>
                                                    ...
                                                    <br />
                                                    {edit ? <TextField hiddenLabel className="mt-2" size="small" variant="filled" name="mother" value={user?.mother} onChange={handleChange} /> : <span>{user?.mother}</span>}
                                                </p>
                                            </div>
                                            <div className="flex items-center mb-2">
                                            ...
                                            <div className="flex items-center mb-2">
                                                ...
                                                <p>
                                                    ...
                                                    <br />
                                                    {edit ? <TextField hiddenLabel className="mt-2" size="small" variant="filled" name="emailid" value={user?.emailid} onChange={handleChange} /> : <span>{user?.emailid}</span>}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                                ...
                                                <div className="flex mb-2">
                                                    ...
                                                    <p>
                                                        ...
                                                        <br />
                                                        {edit ? <TextField hiddenLabel className="mt-2" size="small" variant="filled" name="rollno" value={user?.rollno} onChange={handleChange} disabled /> : <span>{user?.rollno}</span>}
                                                    </p>
                                                </div>
                                                <div className="flex mb-2">
                                                ...
                                                <div className="flex mb-2">
                                                    ...
                                                    <p>
                                                        ...
                                                        <br />
                                                        {edit ? <TextField hiddenLabel className="mt-2" size="small" variant="filled" name="role" value="Student" disabled /> : <span>Student</span>}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
