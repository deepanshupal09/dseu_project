...
export async function sendEmail(rollno: string) {
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/sendEmail", {
            method: "GET",
            mode: "cors",
            cache: "no-cache",
            headers: {
...
export async function verifyOtpAndPassword(rollno: string, otp: string) {
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/verifyOtpAndPassword", {
            method: "GET",
            mode: "cors",
            cache: "no-cache",
            headers: {
...
export async function updatePasswordByOtp(rollno: string, password: string) {
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/updatePasswordByOtp", {
            method: "GET",
            mode: "cors",
            cache: "no-cache",
            headers: {
...
export async function loginAdmin(email: string, password: string) {
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/loginByEmailId", {
            method: "GET",
            mode: "cors",
            cache: "no-cache",
            headers: {
...
export async function fetchExamRegistrationByProgramAndSemester(token: string, campus: string, program_type: string, program: string, semester: string) {
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/api/admin/fetchExamRegistrationByProgramAndSemester", {
            method: "GET",
            mode: "cors",
            headers: {
                "Content-Type": "application/json",
...
export async function fetchCoursesBySemester(token: string, campus: string, program: string, semester: string) {
    try {
        //
        const response = await fetch("https://admin-exam.dseu.ac.in/api/admin/fetchCoursesBySemester", {
            method: "GET",
            mode: "cors",
            headers: {
                "Content-Type": "application/json",
...
export async function fetchExamRegistrationByCourseCode(token: string, campus: string, course_code: string) {
    try {
        //
        const response = await fetch("https://admin-exam.dseu.ac.in/api/admin/fetchExamRegistrationByCourseCode", {
            method: "GET",
            mode: "cors",
            headers: {
                "Content-Type": "application/json",
...
export async function fetchCourseDetailsByCourseCode(token: string, coursedetails: { campus: string; program: string; coursecode: string[] }) {
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/api/admin/fetchCourseDetailsByCourseCode", {
            method: "POST",
            mode: "cors",
            headers: {
                "Content-Type": "application/json",
...
export async function updateDetails(user: StudentDetails, token: string) {
    try {
        ...
        const response = await fetch("https://admin-exam.dseu.ac.in/api/admin/updateDetailsByRollno", {
            method: "POST",
            mode: "cors",
            headers: {
                "Content-Type": "application/json",
...
export async function updateDetailsUser(user: StudentDetails, token: string) {
    try {
        ...
        const response = await fetch("https://admin-exam.dseu.ac.in/api/data/updateDetailsByRollno", {
            method: "POST",
            mode: "cors",
            headers: {
                "Content-Type": "application/json",
...
export async function fetchExamControl(token: string, campus: string, program: string, semester: string) {
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/api/data/fetchExamControl", {
            method: "GET",
            mode: "cors",
            headers: {
                "Content-Type": "application/json",
...
export async function getUserByRollNo(rollno: string, token: string) {
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/api/admin/getUserByRollno", {
            method: "GET",
            mode: "cors",
            headers: {
                "Content-Type": "application/json",
...
export async function fetchUserByRollno(rollno: string, token: string) {
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/api/data/getUserByRollno", {
            method: "GET",
            mode: "cors",
            headers: {
                "Content-Type": "application/json",
...
export async function fetchCampusDetailsGlobal() {
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/fetchCampusDetails", {
            method: "GET",
            mode: "cors",
            headers: {
                "Content-Type": "application/json",
...
export async function deleteExamRegistration(rollno: string, token: string) {
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/api/admin/deleteExamRegistrationByRollno", {
            method: "GET",
            mode: "cors",
            headers: {
                "Content-Type": "application/json",
...
export async function fetchUpdateExamControl(body: { campus: string; program: string; semester: number; exam_control: boolean }[], token: string) {
    console.log(body);
    try {
        const response = await fetch("https://admin-exam.dseu.ac.in/api/admin/updateExamControl", {
            method: "POST",
            mode: "cors",
            cache: "no-cache",
            headers: {
