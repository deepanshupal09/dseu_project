...
const IDDetails: React.FC<IDDetailsProps> = ({
    ...
    return (
        <form
            ...
            className="flex flex-col bg-white rounded-3xl shadow-2xl max-[450px]:w-[100vw] max-[450px]:h-[100vh] p-6 items-center space-y-10 justify-start w-[450px] h-fit pt-16 pb-10 px-10 max-[450px]:backdrop-blur-0 max-[450px]:rounded-none  my-10"
        >
