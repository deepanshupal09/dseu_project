...
export default function Registration() {
    ...
    const renderTableRows = (student:any) => {
        ...
        const normalCourseRows = markSheet.aggregateMarks.map((aggregateMark:any, index:any) => {
            const internalMark = (markSheet.internalMarks || []).find(mark => mark.course_code === aggregateMark.course_code) || {};
            const externalMark = (markSheet.externalMarks || []).find(mark => mark.course_code === aggregateMark.course_code) || {};
            return (
