        ...
        getAuthAdmin().then(async (t: any) => {
            if (t) {
                ...
                if (data?.user?.role === "super") {
                    setOptions(["Dashboard","Registration Chart", "Admit Card", "Query","Exam Control","Marks Entry","Marks Control","Marks Status", "Edit Student Details","Result Control", "Student Result","Results"]);
                }
