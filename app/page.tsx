      ...
      <div className=" ">
        <div className="flex self-center justify-center min-h-[100vh]  items-center">
          ...
          >
            ...
            <div onClick={()=>{router.push("/admin")}} className="w-full  cursor-pointer hover:underline ">Are you an admin?</div>
            <div onClick={()=>{router.push("/forgotpassword")}} className="w-full text-right cursor-pointer hover:underline">Forgot Password?</div>
            </div>
          </form>
        </div>
      </div>
