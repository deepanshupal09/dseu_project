...
import { Typography, Grid, Avatar, Table, TableHead, TableBody, TableRow, TableCell, Checkbox, FormGroup, FormControlLabel, Select, MenuItem, FormControl, Button } from '@mui/material';
...
export default function Home() {
  ...
  const handleChangeSemester = (event: React.ChangeEvent<{ value: unknown }>) => {
  ...
  return (
    <>
        ...
        <Grid container alignItems="center" justifyContent="space-between">
          <Grid item xs={12} sm={6} md={7} lg={8}>
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <Typography variant="h6" component="h2">{prof1.username}</Typography>
                <Typography variant="body1" component="p">Roll Number: {prof1.rollNumber}</Typography>
                <Typography variant="body1" component="p">Semester: {prof1.semester}</Typography>
              </div>
            </div>
          </Grid>
          <Grid item xs={12} sm={6} md={5} lg={4}>
            <div className="text-right">
              <Typography variant="body1" component="p">Campus: {prof1.campusName}</Typography>
              <Typography variant="body1" component="p">Program: {prof1.programName}</Typography>
            </div>
          </Grid>
        </Grid>
      </div>
      ...
      <div className='py-2 px-6 rounded shadow mx-auto my-6 flex flex-col sm:flex-row items-center justify-between max-w-6xl'>
        ...
        <Button onClick={handleSubjectsSelected}>Submit Subjects</Button>
      </div>
      ...
      <div className='py-2 px-6 rounded shadow mx-auto my-6 flex flex-col items-center justify-between max-w-6xl'>
        ...
        <Button onClick={handleBacklogsSelected}>Submit Backlogs</Button>
      </div>
